...
let erNaN = "Text" / 0; //type of number - значение NaN
console.log(erNaN);
console.log(typeof erNaN);
let inf = 1 / 0; //type of number - значение Infinity
console.log(inf);
...
let ageManager; //тип undefined т.е. неопределенный, пока не задали значение, будет undefined
